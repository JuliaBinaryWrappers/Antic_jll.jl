...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Antic_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("e21ec000-9f72-519e-ba6d-10061e575a27"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Antic", artifacts_toml) for e in artifacts["Antic"]]
...
if best_platform === nothing
    @debug("Unable to load Antic; unsupported platform $(triplet(platform_key_abi()))")
else
