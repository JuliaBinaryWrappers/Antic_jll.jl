# Autogenerated wrapper script for Antic_jll for x86_64-apple-darwin14
export libantic
...
const libantic_splitpath = ["lib", "libantic.dylib"]
...
const libantic = "@rpath/libantic-0.0.1.dylib"
